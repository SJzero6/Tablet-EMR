...
class FilterAppointments extends StatefulWidget {
  ...
  const FilterAppointments({super.key, required this.doctorName});
...
class _DoctorAppointmentListState extends State<DoctorAppointmentList> {
  ...
  @override
  Widget build(BuildContext context) {
    List<AppoinmentData> filteredAppointments = widget.obj
        .where((appointment) =>
            appointment.doctorName.toString().toLowerCase() ==
            widget.doctorname)
        .toList();
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          String time24 =
              filteredAppointments[index].appointmentTime.toString();
          ...
          bool isPast = _isPastAppointment(
              filteredAppointments[index].appoinmentDate,
              filteredAppointments[index].appointmentTime.toString());
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${filteredAppointments[index].doctorName}',
                                style: TextStyle(
                              ...
                              Text(
                                "${filteredAppointments[index].doctorDepartment}",
                                style: TextStyle(
  ...
  void _cancelAppointment(
    ...
    appointmentProvider
      ...
      setState(() {
        widget.obj.remove(
            appointment); // Ensure filteredAppointments is synchronized with the provider
      });
    }).catchError((error) {
      // Handle error
